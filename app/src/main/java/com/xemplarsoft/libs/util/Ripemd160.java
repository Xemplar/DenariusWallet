...
public final class Ripemd160 {
    ...
    public static void compress(int[] state, byte[] blocks, int len) {
        if (len % BLOCK_LEN != 0)
    ...
    public static final int[] KL = {0x00000000, 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xA953FD4E};  // Round constants for left line
    public static final int[] KR = {0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0x7A6D76E9, 0x00000000};  // Round constants for right line

    public static final int[] RL = {  // Message schedule for left line
    ...
    public static final int[] RR = {  // Message schedule for right line
    ...
    public static final int[] SL = {  // Left-rotation for left line
    ...
    public static final int[] SR = {  // Left-rotation for right line
